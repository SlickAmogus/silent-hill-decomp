...
typedef struct {
    ...
    int sharp2dOverrides;    /* 1 = nearest-sample HD 2D/menu texture-mod replacements to kill font-atlas edge bleed ("ghost text"); default 0 (config key: sharp_2d_overrides) */
