...
s_AnimInfo CYBIL_ANIM_INFOS[] = {
    ...
    { Anim_PlaybackLoop, ANIM_STATUS(CybilAnim_4,  true),  false, ANIM_STATUS(CybilAnim_4,  true),  { Q12(15.0f)  }, 50,       62  },
    { Anim_BlendLinear,  ANIM_STATUS(CybilAnim_5,  false), false, ANIM_STATUS(CybilAnim_5,  true),  { Q12(5.0f)   }, NO_VALUE, 63  },
