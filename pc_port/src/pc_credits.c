...
static const s_PcCreditRow s_Rows[] = {
    ...
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Name,   "Chris Hardin", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Name,   "KushAstronaut", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    ...
    { PcCreditRow_Header, "Built On", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Pair,   "Decompilation", "silent-hill-decomp" },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Pair,   "PSX Layer", "PsyCross" },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    ...
    { PcCreditRow_Name,   "sh1pc.com", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
};
