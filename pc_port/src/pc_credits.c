...
static const s_PcCreditRow s_Rows[] = {
    ...
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Header, "Supporters", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Name,   "svperstar", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Name,   "frazzle1", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Name,   "cristinathegamer", NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    ...
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Pair,   "DanielaPC!?SFM", "QoL Mods" },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
    { PcCreditRow_Blank,  NULL, NULL },
