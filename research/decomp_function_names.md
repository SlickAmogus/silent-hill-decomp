 ...
 */
void Mesh_NormalLightingCompute(s_MeshHeader* meshHdr, s32 normalOffset, s_GteScratchData2* scratchData);
```
...
void Combat_CharaMoveAndCollide(s_SubCharacter* chara, s_800C4590* collisionResult);
```
