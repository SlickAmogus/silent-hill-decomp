...
{
    /* 0x0 */ e_ControllerMenuState preset;
    /* 0x4 */ e_InputAction         action;
 ...
 * @param hasShadow @unused `true` for a highlight with a shadow and a line, `false` for a line only. Always passed as `true`.
