...
// Re-added from fork (dropped during merge).
typedef enum _AirScreamerStateStep
{
    AirScreamerStateStep_0  = 0,  AirScreamerStateStep_1  = 1,  AirScreamerStateStep_2  = 2,
    AirScreamerStateStep_3  = 3,  AirScreamerStateStep_4  = 4,  AirScreamerStateStep_5  = 5,
    AirScreamerStateStep_6  = 6,  AirScreamerStateStep_7  = 7,  AirScreamerStateStep_8  = 8,
    AirScreamerStateStep_9  = 9,  AirScreamerStateStep_10 = 10, AirScreamerStateStep_11 = 11,
    AirScreamerStateStep_12 = 12, AirScreamerStateStep_13 = 13,
    AirScreamerStateStep_64 = 64, AirScreamerStateStep_65 = 65, AirScreamerStateStep_66 = 66,
    AirScreamerStateStep_67 = 67
} e_AirScreamerStateStep;

typedef enum _AirScreamerDamage
{
    AirScreamerDamage_None = 0, AirScreamerDamage_1 = 1, AirScreamerDamage_2 = 2,
    AirScreamerDamage_3 = 3, AirScreamerDamage_4 = 4
} e_AirScreamerDamage;
...
/** Probes collision and sets `airScreamerProps.groundHeight`. */
