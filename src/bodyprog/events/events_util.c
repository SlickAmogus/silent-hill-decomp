...
void Event_BgTextureCmd(e_BgTextureCmd cmd, e_FsFile textureFileIdx, bool incSubStep) // 0x800862F8
{
    ...
    switch (activeCmd)
    {
        case BgTextureCmd_QueueRead:
            Fs_QueueStartReadTim(textureFileIdx, FS_BUFFER_1, &g_ItemInspectionImg);
        ...
        case BgTextureCmd_QueueReadSecondary:
            Fs_QueueStartReadTim(textureFileIdx, FS_BUFFER_1, &D_800A9A04);
...
void Event_BgTextureLoadFadeIn(e_FsFile textureFileIdx, q19_12 fadeTimestep) // 0x80086DA8
{
    switch (g_SysWork.sysStateSteps[1])
    {
        case 0:
...
void Event_BgTextureFadeIn(e_FsFile textureFileIdx, q19_12 fadeTimestep0, q19_12 fadeTimestep1) // 0x80086E50
{
    switch (g_SysWork.sysStateSteps[1])
    {
        case 0:
...
void Event_DisplayMapMsgWithBg(e_FsFile textureFileIdx, q19_12 fadeTimestep0, q19_12 fadeTimestep1, s32 mapMsgIdx) // 0x80087360
{
    // TODO: Name these.
...
void Event_DisplayMapMsgWithDimmedBg(e_FsFile textureFileIdx, q19_12 fadeTimestep0, q19_12 fadeTimestep1, s32 mapMsgIdx0, s32 mapMsgIdx1) // 0x80087540
{
    // TODO: Name these.
    typedef enum _EventStates
    {
