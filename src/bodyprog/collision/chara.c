...
void Collision_CharaCollisionSet(s_SubCharacter* chara, s_Keyframe* keyframe0, s_Keyframe* keyframe1) // 0x80070400
{
    ...
    chara->collision.box.top                  = FP_FROM((keyframe0->field_0                  * invAlpha) + (keyframe1->field_0                  * alpha), Q12_SHIFT);
    chara->collision.box.bottom               = FP_FROM((keyframe0->field_2               * invAlpha) + (keyframe1->field_2               * alpha), Q12_SHIFT);
    chara->collision.box.height               = FP_FROM((keyframe0->field_4               * invAlpha) + (keyframe1->field_4               * alpha), Q12_SHIFT);
    chara->collision.box.offsetY              = FP_FROM((keyframe0->field_6              * invAlpha) + (keyframe1->field_6              * alpha), Q12_SHIFT);
    chara->collision.shapeOffsets.cylinder.vx = FP_FROM((keyframe0->field_10 * invAlpha) + (keyframe1->field_10 * alpha), Q12_SHIFT);
    chara->collision.shapeOffsets.cylinder.vz = FP_FROM((keyframe0->field_12 * invAlpha) + (keyframe1->field_12 * alpha), Q12_SHIFT);
    chara->collision.cylinder.radius          = FP_FROM((keyframe0->field_8              * invAlpha) + (keyframe1->field_8              * alpha), Q12_SHIFT);
    chara->collision.shapeOffsets.box.vx      = FP_FROM((keyframe0->field_C      * invAlpha) + (keyframe1->field_C      * alpha), Q12_SHIFT);
    chara->collision.shapeOffsets.box.vz      = FP_FROM((keyframe0->field_E      * invAlpha) + (keyframe1->field_E      * alpha), Q12_SHIFT);
