...
s32 func_8008A3E0(s_SubCharacter* chara) // 0x8008A3E0
{
    ...
    if (chara == &g_SysWork.playerWork.player)
    {
        var_s0 = &((s_PlayerWork*)chara)->extra.model.anim;
    }
    else
    {
...
s32 func_8008B714(s_SubCharacter* attacker, s_SubCharacter* target, VECTOR3* arg2, s32 arg3) // 0x8008B714
{
     ...
     *     ~Nframes x damage and N x knockback at high fps — "combat too
     *     fast". For the player target sp10 == NO_VALUE (-1), so
     *     (sp14 & sp10) == sp14 is a valid "already hit this swing" test
     *     and sp14 |= sp10 latches it the same way.
     *
...
s32 func_8008BF84(s_SubCharacter* chara, q19_12 angle, s_800AD4C8* arg2, s32 arg3) // 0x8008BF84
{
    ...
    {
        chara0 = &g_SysWork.playerWork.player;
        var_v0 = 1;
        var_v1 = -1;
    }
