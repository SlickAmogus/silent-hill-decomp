...
s_AnimInfo HARRY_M2S02_ANIM_INFOS[33] = {
    ...
    { Anim_Update1, ANIM_STATUS(46, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 812, 825 },
    ...
    { Anim_Update1, ANIM_STATUS(48, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 833, 846 },
