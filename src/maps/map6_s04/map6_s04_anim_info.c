...
s_AnimInfo HARRY_M6S04_ANIM_INFOS[77] = {
    ...
    { Anim_Update1, ANIM_STATUS(55, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 1022, 1033 },
    { Anim_Update2, ANIM_STATUS(56, false), false, ANIM_STATUS(56, true), { Q12(10) }, NO_VALUE, 1034 },
    { Anim_Update1, ANIM_STATUS(56, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 1034, 1045 },
