...
SH_MAP_OVERLAY_HEADER = {
    ...
    .charaUpdateFuncs_194             = {
        ...
        NULL, NULL, Ai_HangedScratcher_Update, Ai_Creeper_Update },
    .charaGroupIds_248 = { Chara_HangedScratcher, Chara_Creeper },
    .charaSpawns_24C   = {
