...
SH_MAP_OVERLAY_HEADER = {
    ...
    .charaUpdateFuncs             = {
        ...
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, Twinfeeler_Update },
    .charaGroupIds = { Chara_Twinfeeler },
    .charaSpawnInfos   = {
