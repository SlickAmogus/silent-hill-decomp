...
extern s_AnimInfo HARRY_M3S01_ANIM_INFOS[];
...
void (*g_MapEventFuncs[])() = {
    ...
    MapEvent_UnknownLiquidInteract,
    MapEvent_UseBottleOnLiquid,
    MapEvent_PlasticBottleTake,
    MapEvent_PaperMapTake0,
    MapEvent_PaperMapTake1,
    func_800D279C,
    MapEvent_Generator0,
    func_800D2A88,
    func_800D29A4
...
SH_MAP_OVERLAY_HEADER = {
    ...
    .harryMapAnimInfos                     = HARRY_M3S01_ANIM_INFOS,
