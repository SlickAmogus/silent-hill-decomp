...
SH_MAP_OVERLAY_HEADER = {
    ...
    .charaUpdateFuncs_194             = {
        ...
        Ai_Stalker_Update, Ai_Stalker_Update, NULL, Ai_Creeper_Update },
    .charaGroupIds_248 = { Chara_GreyChild, Chara_Creeper },
    .charaSpawns_24C   = {
