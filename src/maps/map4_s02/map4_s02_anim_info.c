...
s_AnimInfo HARRY_M4S02_ANIM_INFOS[35] = {
    ...
    { Anim_Update1, ANIM_STATUS(47, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 831, 844 },
    ...
    { Anim_Update1, ANIM_STATUS(49, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 852, 865 },
