...
extern s_AnimInfo HARRY_M6S03_ANIM_INFOS[];
...
SH_MAP_OVERLAY_HEADER = {
    .mapInfo_0                        = &MAP_INFOS[MapType_DRU],
    .getMapRoomIdxFunc_4              = Map_RoomIdxGet,
    .field_8                          = 0,
    .func_C                           = sharedFunc_800D929C_0_s00,
    .bgmEvent_10                      = func_800D7F98,
    .bgmIdx_14                        = 12,
    .ambientAudioIdx_15               = 34,
    .field_16                         = 2,
    .field_17                         = 5,
    ...
    .charaUpdateFuncs_194             = {
        ...
        Ai_Stalker_Update, Ai_Stalker_Update, Ai_HangedScratcher_Update },
    .charaGroupIds_248 = { Chara_HangedScratcher, Chara_Mumbler },
    .charaSpawns_24C   = {
