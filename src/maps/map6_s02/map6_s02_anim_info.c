...
s_AnimInfo HARRY_M6S02_ANIM_INFOS[43] = {
    ...
    { Anim_Update1, ANIM_STATUS(47, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 827, 840 },
    ...
    { Anim_Update1, ANIM_STATUS(49, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 848, 861 },
