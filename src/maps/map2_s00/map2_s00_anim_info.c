...
s_AnimInfo HARRY_M2S00_ANIM_INFOS[39] = {
    ...
    { Anim_Update1, ANIM_STATUS(47, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 823, 836 },
    ...
    { Anim_Update1, ANIM_STATUS(49, true), true, NO_VALUE, { .variableFunc = (q19_12 (*)(void))func_800706E4 }, 844, 857 },
