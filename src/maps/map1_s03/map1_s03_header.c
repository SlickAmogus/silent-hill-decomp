...
extern s_AnimInfo HARRY_M1S03_ANIM_INFOS[];
...
SH_MAP_OVERLAY_HEADER = {
    ...
    .charaUpdateFuncs             = {
        ...
        Stalker_Update, Stalker_Update, NULL, Creeper_Update, NULL, NULL, NULL, NULL,
