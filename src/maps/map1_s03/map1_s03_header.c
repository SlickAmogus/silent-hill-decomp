...
SH_MAP_OVERLAY_HEADER = {
    ...
    .charaUpdateFuncs_194             = {
        ...
        NULL, Ai_LockerDeadBody_Update },
    .charaGroupIds_248 = { Chara_GreyChild, Chara_Creeper, Chara_LockerDeadBody },
    .charaSpawns_24C   = {
