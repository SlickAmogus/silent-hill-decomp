...
extern s_AnimInfo HARRY_M3S02_ANIM_INFOS[];
...
SH_MAP_OVERLAY_HEADER = {
    ...
    .harryMapAnimInfos                     = HARRY_M3S02_ANIM_INFOS,
    ...
    .playerPathWaypointExecute                          = sharedFunc_800D23EC_0_s00,
    .playerAnimStateSet                          = sharedFunc_800D2C7C_0_s00,
    .playerAnimReset                          = sharedFunc_800D2D2C_0_s00,
    ...
    .func_68                          = sharedFunc_800D2E7C_0_s00,
    ...
    .charaAnimStateSet                         = sharedFunc_800D8904_0_s00,
    .charaAnimReset                         = Player_RunTimerReset,
    .charaAnimLock                         = Chara_Lock,
    .charaAnimIsLocked                         = Chara_IsLockedCheck,
    .charaAnimUnlock                         = Chara_Unlock,
    .charaAnimPlaybackStateGet                         = Chara_AnimPlaybackStateGet,
    .charaPathWaypointExecute                         = sharedFunc_800D8A00_0_s00,
    ...
    .charaUpdateFuncs             = {
        ...
        NULL, NULL, NULL, Creeper_Update, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, Alessa_Update },
    .charaGroupIds = { Chara_Creeper, Chara_Alessa },
    .charaSpawnInfos   = {
